...
avgRow = '<tr class="avgRow averageRow"><td colspan="2"><b>AVERAGES</b></td>';
for f = 3:width(Tsum)
    col = Tsum.Properties.VariableNames{f};
    if strcmp(col,'Level')
...
statRow = sprintf('<tr class="avgRow statRow"><td colspan="9" style="text-align:center;color:#000;">Games Played: %d / %d (%.1f%%)</td></tr>', ...
...
backHTML = [ ...
    '<p class="backLink">' ...
    '<a href="../../index.html">⬅ Back to All Leagues</a>' ...
    '</p>' ...
    ];
